...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/exports/master/_listings/google-cloud-sql/apis.md
specificationVersion: "0.14"
apis:
- name: Cloud SQL Administration - Add Projects Project Instances Instance Export
  x-api-slug: projectsprojectinstancesinstanceexport-post
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/exports/master/_listings/google-cloud-sql/projectsprojectinstancesinstanceexport-post-openapi.md
- name: Cloud SQL Administration - Add Projects Project Instances Instance Export
  x-api-slug: projectsprojectinstancesinstanceexport-post
  description: Exports data from a Cloud SQL instance to a Google Cloud Storage bucket
    as a MySQL dump file.
